...
URL = "https://github.com/empkins/emrad-toolbox"
...
sphinx_gallery_conf = {
    ...
    "reference_url": {"emrad_toolbox": None, **{k: v[0] for k, v in intersphinx_module_mapping.items()}},
    # 'default_thumb_file': 'fig/logo.png',
    "backreferences_dir": "modules/generated/backreferences",
    "doc_module": ("emrad_toolbox",),
...
linkcode_resolve = make_linkcode_resolve(
    "emrad_toolbox",
    "https://github.com/empkins/emrad-toolbox/blob/{revision}/{package}/{path}#L{lineno}",
)
